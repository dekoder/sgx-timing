...
const Ipp16u AesGcmConst_table[256] __attribute__ ((aligned (2048))) = {
...
int main(int argc,char **argv) {
	...
	*/
	...
	prime_start = 1;
	memset(evict_count, 0x0, TIMES*LINES*4);

	while (!thread_done);

	for (m_i = 0; m_i < TIMES; m_i++) {
		/*
		for (m_j = 0; m_j < LINES; m_j++) {
...
//		my_prime_i(4);evict_count[m_i][3] = my_asm_probe(4);
		...
		// my_prime_i(19);evict_count[m_i][2] = my_asm_probe(19);
		// my_prime_i(20);evict_count[m_i][3] = my_asm_probe(20);

//		my_prime_i(28);evict_count[m_i][6] = my_asm_probe(28);
//		my_prime_i(12);evict_count[m_i][7] = my_asm_probe(12);
